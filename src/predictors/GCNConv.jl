...
julia> formulation
GCNConv{Float64}([1.0; 2.0;;], [7.0], [1.0 0.40824829046386296 0.0; 0.40824829046386296 1.0 0.40824829046386296; 0.0 0.40824829046386296 1.0])
├ variables [3]
│ ├ moai_GCNConv[1]
│ ├ moai_GCNConv[2]
│ └ moai_GCNConv[3]
└ constraints [3]
  ├ -x[1,1] - 0.40824829046386296 x[2,1] - 2 x[1,2] - 0.8164965809277259 x[2,2] + moai_GCNConv[1] = 7
  ├ -0.40824829046386296 x[1,1] - x[2,1] - 0.40824829046386296 x[3,1] - 0.8164965809277259 x[1,2] - 2 x[2,2] - 0.8164965809277259 x[3,2] + moai_GCNConv[2] = 7
  └ -0.40824829046386296 x[2,1] - x[3,1] - 0.8164965809277259 x[2,2] - 2 x[3,2] + moai_GCNConv[3] = 7
```
"""
