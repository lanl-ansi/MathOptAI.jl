...
include("predictors/GCNConv.jl")
include("predictors/GELU.jl")
include("predictors/GrayBox.jl")
include("predictors/LayerNorm.jl")
include("predictors/LeakyReLU.jl")
include("predictors/MaxPool2d.jl")
include("predictors/MaxPool2dBigM.jl")
include("predictors/Permutation.jl")
include("predictors/Pipeline.jl")
include("predictors/PytorchModel.jl")
include("predictors/Quantile.jl")
include("predictors/ReLU.jl")
include("predictors/ReLUBigM.jl")
include("predictors/ReLUEpigraph.jl")
include("predictors/ReLUQuadratic.jl")
include("predictors/ReLUSOS1.jl")
include("predictors/Scale.jl")
include("predictors/Sigmoid.jl")
